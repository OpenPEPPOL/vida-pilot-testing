...
* C2 generates the supply-side TDD (file `expected-results/NW-HP-001.PeppolBIS.TDD-C2.xml`)
...
* C3 generates the buy-side TDD (file `expected-results/NW-HP-001.PeppolBIS.TDD-C3.xml`)
...
* C5 receives inbound TDD from C2/C3, files
  * `expected-results/NW-HP-001.PeppolBIS.TDD-C2.xml` resp.
  * `expected-results/NW-HP-001.PeppolBIS.TDD-C3.xml`.
...
* C3 sends positive MLS to C2 (file `expected-results/NW-HP-001.PeppolBIS.MLS-C3.xml`)
* C5A sends positive MLS to C2 (file `expected-results/NW-HP-001.PeppolBIS.MLS-C5A.xml`)
* C5B sends positive MLS to C3 (file `expected-results/NW-HP-001.PeppolBIS.MLS-C5B.xml`)
