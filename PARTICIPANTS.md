...
To begin, copy the template directory and rename using your `SP-ID`, a dash `-` and your company name.
...
| Tax Administration     | SPID   | Role | Contact Name          | 
|------------------------|--------|------|-----------------------|
| AT - Austria           | 001067 | C5   |                       | 
...
| Peppol Playground  | SPID   | Role  | Contact Name          | 
|------------------------|--------|-------|-----------------------|
| Sending Service Provider    | 001109 | C2 |         | 
| Receiving Service Provider  | 001110 | C3 |         | 
| Tax Admin Service Provider  | 001111 | C5 |         | 
