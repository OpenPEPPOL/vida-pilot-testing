...
This repository is designed to provide invoices as test files for the Peppol ViDA Pilot Testing phase.  
...
- **Description**: Each invoice test case comes with detailed description of the intended test scenario, the specific aspects under test and the corresponding expected results.
- **Expected results**
   - Tax Data Document: buy-side=C3, (TODO) sell-side=C2
   - MLS as generated by C3 and both C5s (TODO)
- **Supporting files**
...
## Structure
- **One directory for each test**: Contains the testing files for a specific test case.
